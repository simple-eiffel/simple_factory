...
extern EIF_TYPED_VALUE F18_580(EIF_REFERENCE);
...
EIF_TYPED_VALUE F18_580 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 17, Current, 0, 0, 671);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(17, Current, 671);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(0, 0xF8000254, 0,0); /* Result */
	{
		static EIF_TYPE_INDEX typarr0[] = {0xFF01,596,0xFF01,0,0xFFFF};
		EIF_TYPE typres0;
