...
static const EIF_TYPE_INDEX egt_0_5 [] = {0xFF01,178,0xFFFF};
...
static const EIF_TYPE_INDEX egt_8_5 [] = {0xFF01,11,0xFFFF};
static const EIF_TYPE_INDEX egt_9_5 [] = {0xFF01,178,0xFFFF};
static const EIF_TYPE_INDEX egt_10_5 [] = {0xFF01,178,0xFFFF};
static const EIF_TYPE_INDEX egt_11_5 [] = {0xFF01,12,0xFFFF};
static const EIF_TYPE_INDEX egt_12_5 [] = {0xFF01,4,0xFFFF};
static const EIF_TYPE_INDEX egt_13_5 [] = {0xFF01,6,0xFFFF};
...
static const struct desc_info desc_5[] = {
	...
	{EIF_GENERIC(egt_13_5), 63, 0xFFFFFFFF},
	{EIF_GENERIC(NULL), 64, 0xFFFFFFFF},
	{EIF_GENERIC(NULL), 65, 0xFFFFFFFF},
	{EIF_GENERIC(NULL), 66, 0xFFFFFFFF},
	{EIF_NON_GENERIC(0x0109 /*132*/), 67, 0xFFFFFFFF},
};
void Init5(void)
{
	IDSC(desc_5, 0, 4);
	IDSC(desc_5 + 1, 2, 4);
	IDSC(desc_5 + 32, 156, 4);
}
