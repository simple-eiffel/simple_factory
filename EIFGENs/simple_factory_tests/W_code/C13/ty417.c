...
extern EIF_TYPED_VALUE F417_1971(EIF_REFERENCE);
...
EIF_TYPED_VALUE F417_1971 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 416, Current, 0, 0, 2749);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(416, Current, 2749);
	RTIV(Current, RTAL);
