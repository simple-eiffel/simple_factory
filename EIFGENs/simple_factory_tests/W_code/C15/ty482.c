...
extern EIF_TYPED_VALUE F482_1971(EIF_REFERENCE);
...
EIF_TYPED_VALUE F482_1971 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 481, Current, 0, 0, 2750);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(481, Current, 2750);
	RTIV(Current, RTAL);
