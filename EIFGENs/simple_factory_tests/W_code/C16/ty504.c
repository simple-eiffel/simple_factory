...
extern EIF_TYPED_VALUE F504_1971(EIF_REFERENCE);
...
EIF_TYPED_VALUE F504_1971 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 503, Current, 0, 0, 2751);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(503, Current, 2751);
	RTIV(Current, RTAL);
