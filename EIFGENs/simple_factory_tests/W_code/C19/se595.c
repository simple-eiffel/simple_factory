...
extern EIF_TYPED_VALUE F595_2107(EIF_REFERENCE);
...
EIF_TYPED_VALUE F595_2107 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 594, Current, 0, 0, 3835);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(594, Current, 3835);
	RTIV(Current, RTAL);
	RTHOOK(1);
