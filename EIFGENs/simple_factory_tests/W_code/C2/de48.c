...
EIF_TYPED_VALUE F48_1035 (EIF_REFERENCE Current)
{
	...
	RTEAA(l_feature_name, 47, Current, 0, 0, 1123);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(47, Current, 1123);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(0, 0x10000000, 1,0); /* Result */
	ti4_1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(716, 29))(Current)).it_i4);
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 47, Current, 0, 0, 1124);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(47, Current, 1124);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
