...
extern EIF_TYPED_VALUE F59_1070(EIF_REFERENCE);
...
/* {RESCUE_FAILURE}.code */
EIF_TYPED_VALUE F59_1070 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 58, Current, 0, 0, 1158);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	...
	ti4_1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(706, 29))(Current)).it_i4);
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 58, Current, 0, 0, 1159);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
