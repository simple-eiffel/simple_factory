...
extern EIF_TYPED_VALUE F696_1971(EIF_REFERENCE);
...
EIF_TYPED_VALUE F696_1971 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 695, Current, 0, 0, 2753);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(695, Current, 2753);
	RTIV(Current, RTAL);
