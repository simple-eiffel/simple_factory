...
extern EIF_TYPED_VALUE F734_1971(EIF_REFERENCE);
...
EIF_TYPED_VALUE F734_1971 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 733, Current, 0, 0, 2754);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(733, Current, 2754);
	RTIV(Current, RTAL);
