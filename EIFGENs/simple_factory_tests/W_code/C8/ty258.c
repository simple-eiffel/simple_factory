...
extern EIF_TYPED_VALUE F258_1971(EIF_REFERENCE);
...
EIF_TYPED_VALUE F258_1971 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 257, Current, 0, 0, 2744);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(257, Current, 2744);
	RTIV(Current, RTAL);
